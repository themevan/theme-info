...
if ( ! class_exists( 'Info' ) ) {
  ...
  class Info {
    ...
    public function prepare_content() {
      $keys = array( 'welcome_content', 'quick_links', 'getting_started', 'support', 'useful_plugins', 'demo_content' );
    ...
    public function hooks() {
      ...
      // Dismiss AJAX.
      add_action( 'wp_ajax_medias_dismiss', array( $this, 'dismiss_callback' ) );
      add_action( 'wp_ajax_nopriv_medias_dismiss', array( $this, 'dismiss_callback' ) );
    }
    ...
    public function render_page() {
      ?>
      <div class="wrap about-wrap tmv-info-wrap">
        ...
        <?php endif; ?>
        <a href="https://themevan.com" target="_blank"><div class="wp-badge"></div></a>
      ...
      </div><!-- .wrap .about-wrap .tmv-info-wrap -->
      <?php
    }
    ...
    public function render_tabs() {
      ...
      $current_tab = isset( $_GET['tab'] ) ? wp_unslash( $_GET['tab'] ) : 'getting-started'; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
    ...
    public function getting_started() {
      ...
      ?>
      <div class="feature-section tmv-section tmv-section-getting-started three-col">
        <?php foreach ( $content as $item ) : ?>
          <?php $this->render_grid_item( $item ); ?>
        <?php endforeach; ?>
      </div><!-- .feature-section .tmv-section -->
      <?php
    }
    ...
    public function support() {
      ...
      ?>
      <div class="feature-section tmv-section tmv-section-support three-col">
        <?php foreach ( $content as $item ) : ?>
          <?php $this->render_grid_item( $item ); ?>
        <?php endforeach; ?>
      </div><!-- .feature-section .tmv-section -->
    ...
    public function useful_plugins() {
      ...
      ?>
      <div class="tmv-section tmv-section-useful-plugins">
    ...
    public function demo_content() {
      ...
      ?>
      <div class="tmv-section tmv-section-demo-content">
    ...
    public function upgrade_to_pro() {
      ...
      ?>
      <div class="tmv-section tmv-section-upgrade-to-pro">
    ...
    public function display_admin_notice() {
      ...
      $dismiss_status = get_user_meta( $user_id, "{$this->theme_slug}_dismiss_status", true );
      ?>
      <?php if ( current_user_can( 'edit_theme_options' ) && 'themes' === $screen_id && 1 !== absint( $dismiss_status ) ) : ?>
        <div class="tmv-info-notice notice notice-info">
    ...
    public function dismiss_callback() {
      ...
      update_user_meta( $userid, "{$this->theme_slug}_dismiss_status", 1 );
